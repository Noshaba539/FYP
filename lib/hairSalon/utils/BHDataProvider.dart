...
List<BHBestSpecialModel> getSpecialList() {
  ...
  list.add(BHBestSpecialModel(title: 'Joseph Drake', subTitle: 'Makeup Artist', img: BHDashedBoardImage1));
  ...
  list.add(BHBestSpecialModel(title: 'Joseph Drake', subTitle: 'Makeup Artist', img: BHDashedBoardImage4));
  list.add(BHBestSpecialModel(title: 'Dale Horward', subTitle: 'Hire Stylist', img: BHDashedBoardImage1));
  ...
  list.add(BHBestSpecialModel(title: 'Dale Horward', subTitle: 'Makeup Artist', img: BHDashedBoardImage9));
  list.add(BHBestSpecialModel(title: 'Dale Horward', subTitle: 'Makeup Artist', img: BHDashedBoardImage6));
...
List<BHBestSpecialModel> getSpecialNewList() {
  ...
  list.add(BHBestSpecialModel(title: 'Dale Horward', subTitle: 'Hire Stylist', img: BHDashedBoardImage1));
  list.add(BHBestSpecialModel(title: 'willies carpen', subTitle: 'Barber', img: BHDashedBoardImage6));
  list.add(BHBestSpecialModel(title: 'willies carpen', subTitle: 'Barber', img: BHDashedBoardImage8));
  list.add(BHBestSpecialModel(title: 'willies carpen', subTitle: 'Barber', img: BHDashedBoardImage9));
  list.add(BHBestSpecialModel(title: 'Dale Horward', subTitle: 'Makeup Artist', img: BHDashedBoardImage3));
...
List<BHSpecialOfferModel> getSpecialOfferList() {
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage1, title: 'Joseph Salon', subtitle: 'Cool Summer Event'));
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage8, title: 'Joseph Drake', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage9, title: 'Joseph Drake', subtitle: 'Cool Winter Event'));
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage1, title: 'Joseph Hair', subtitle: 'Cool Summer Event'));
  return specialOfferList;
}

List<BHSpecialOfferModel> getSpecialOfferNewList() {
  List<BHSpecialOfferModel> specialOfferList = List<BHSpecialOfferModel>();
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage1, title: 'Joseph Drake Hair Salon', subtitle: 'Cool Summer Event'));
  ...
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage2, title: 'Joseph Drake Hair Salon', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage8, title: 'Joseph Drake Hair Salon', subtitle: 'Cool Winter Event'));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage9, title: 'Joseph Drake Hair Salon', subtitle: 'Abdul Rehman '));
  specialOfferList.add(BHSpecialOfferModel(img: BHDashedBoardImage4, title: 'Joseph Drake Hair Salon', subtitle: 'Test by Abdul Rehman '));
  return specialOfferList;
}
...
List<BHServicesModel> getServicesList() {
  ...
  servicesList.add(BHServicesModel(img: BHDashedBoardImage1, serviceName: 'Skin Care', time: '30 Min', price: 150, radioVal: 4));
  return servicesList;
}
...
List<BHIncludeServiceModel> getIncludeServicesList() {
  ...
  servicesList.add(BHIncludeServiceModel(serviceImg: BHDashedBoardImage1, serviceName: 'Skin Care', time: '30 Min', price: 150));
...
List<BHMakeUpModel> getMakeupList() {
  ...
  makeupList.add(BHMakeUpModel(img: BHDashedBoardImage1, name: 'Dale Horward'));
...
List<BHNotifyModel> getNotifyList() {
  ...
  notifyList.add(
    BHNotifyModel(img: BHDashedBoardImage1, name: 'Norah Beauty Salon', address: '301 Dorthy walks,chicago,Us.', rating: 5.0, distance: 17.5),
  );
  notifyList.add(
