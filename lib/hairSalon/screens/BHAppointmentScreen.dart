                  ...
                  Row(
                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: commonCacheImageWidget(BHDashedBoardImage1, 110, width: 120, fit: BoxFit.cover),
                      ),
                      8.width,
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.all(Radius.circular(10)),
                        child: commonCacheImageWidget(BHDashedBoardImage2, 70, width: 130, fit: BoxFit.cover),
                      ),
                      8.width,
                      Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
