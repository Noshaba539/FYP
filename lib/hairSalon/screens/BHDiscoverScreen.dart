          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                children: [
                  Row(
                    children: [
                      ...
                      8.width,
                      Text('Noshaba,', style: TextStyle(fontSize: 18, color: BHColorPrimary, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  GestureDetector(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Our Services', style: TextStyle(fontSize: 16, color: BHAppTextColorPrimary, fontWeight: FontWeight.bold)),
                  GestureDetector(
                    onTap: () {
                      sendTextDataOffer(context);
                    },
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      commonCacheImageWidget(specialOfferNewList[index].img, 100, width: 200, fit: BoxFit.cover),
                      )
                    );
                  },
                ),
